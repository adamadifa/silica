<x-app-layout>
    ...
    <div x-data="journalEntry()" class="pb-24 w-full" x-init="init()">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
            <div>
                <span class="inline-block px-3 py-1 bg-blue-50 text-blue-600 rounded-lg text-xs font-bold mb-3">Adjustment Posting</span>
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Catat Jurnal Penyesuaian</h1>
                <p class="text-slate-500 font-medium text-sm mt-1">Pencatatan akun secara akurat pada akhir periode akuntansi.</p>
            </div>
        ...
        <form action="{{ route('mahasiswa.jurnal-penyesuaian.store') }}" method="POST" class="space-y-6">
            @csrf
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                        <div class="md:col-span-3">
                            ...
                            <input type="text" name="tanggal" id="tanggal" class="datepicker w-full px-4 py-2.5 bg-slate-50 border-transparent rounded-xl focus:bg-white focus:border-blue-600 focus:ring-0 transition-all font-bold text-slate-700 text-sm" required placeholder="Pilih Tanggal">
                        </div>

                        <div class="md:col-span-3">
                            <label for="nomor_bukti" class="block text-sm font-bold text-slate-500 mb-2 px-1">Nomor Bukti</label>
                            <input type="text" name="nomor_bukti" id="nomor_bukti" class="w-full px-4 py-2.5 bg-slate-50 border-transparent rounded-xl focus:bg-white focus:border-blue-600 focus:ring-0 transition-all font-bold text-slate-700 text-sm" placeholder="AJP-001" required>
                        </div>

                        <div class="md:col-span-6">
                            <label for="keterangan" class="block text-sm font-bold text-slate-500 mb-2 px-1">Keterangan Jurnal</label>
                            <input type="text" name="keterangan" id="keterangan" class="w-full px-4 py-2.5 bg-slate-50 border-transparent rounded-xl focus:bg-white focus:border-blue-600 focus:ring-0 transition-all font-bold text-slate-700 text-sm" placeholder="Contoh: Penyesuaian beban sewa kantor" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full flex items-center justify-between bg-white/95 backdrop-blur-sm border border-slate-200 rounded-2xl p-4 shadow-2xl">
                    ...
                    <div class="flex items-center space-x-4 pr-6">
                        ...
                        <button type="submit" 
                            ...
                            <span>Simpan Jurnal Penyesuaian</span>
