@props(['active', 'icon' => 'dashboard'])

@php
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-3 text-sm font-bold text-white bg-blue-600 rounded-2xl shadow-lg shadow-blue-100 transition-all'
            : 'flex items-center px-4 py-3 text-sm font-bold text-slate-500 hover:text-blue-600 hover:bg-slate-50 rounded-2xl transition-all group';
...
$iconSvg = [
    ...
    'financial' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>',
    'class' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>',
...
<a {{ $attributes->merge(['class' => $classes]) }}>
    <div class="flex items-center justify-center w-5 h-5 mr-3 transition-colors {{ ($active ?? false) ? 'text-white' : 'text-slate-400 group-hover:text-blue-600' }}">
